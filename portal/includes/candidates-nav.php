                            ...
                            <div class="nv-nav-wrap">
                                <div role="navigation" class="collapse navbar-collapse nav-menu-primary" aria-label="Primary Menu" id="salmonNavbarContent">
                                    <ul id="nv-primary-navigation-main" class="primary-menu-ul nav-ul">
                                        <li id="candidatesShares" class="menu-item <?php if ($page == 'shares') {
                                                            echo 'active';
                                                        } ?>">
                                            <a href="<?php echo BASE_URL ?>/portal/01_candidates/shares.php">
                                                <i data-feather="layout"></i>
                                                <span class="menu-item-title-wrap">Local</span>
                                            </a>
                                        </li>
                                        <li id="candidatesRaces" class="menu-item <?php if ($page == 'races') {
                                                            echo 'active';
                                                        } ?>">
                                            <div class="menu-item-name-cart">
                                                <a href="<?php echo BASE_URL ?>/portal/01_candidates/races.php">
                                                    <i data-feather="users"></i>
                                                    <span class="menu-item-title-wrap">Races</span>
                                                </a>
                                            </div>
                                        </li>
                                        <li id="candidatesConstituent" class="menu-item <?php if ($page == 'constituent') {
                                                            echo 'active';
                                                        } ?>">
                                            <div class="menu-item-name-cart">
                                                <a href="<?php echo BASE_URL ?>/portal/01_candidates/constituent.php">
                                                    <i data-feather="user"></i>
                                                    <span class="menu-item-title-wrap">Constituent</span>
                                                </a>
                                            </div>
                                        </li>
                                    </ul>
                        ...
                        <div class="item--menu profile-menu <?php if ($page == 'MyProfile') {
                            ...
                            <div class="dropdown">
                                <div class="dropdown-toggle profile-menu-image" id="dropdownMenuButton" data-toggle="dropdown">
                                    <img src="<?php echo BASE_URL ?>/assets/img/avatar8.jpg" class="img-circle" id="candidatesProfile" alt="">
                                </div>
...
<script>
    ...
    var tour = new Tour({
        steps: [{
                element: "#candidatesShares",
                title: "Shares",
                content: "Lorem ipsum dolor sit, amet consectetur adipisicing elit. Sed, ipsum?",
                placement: "bottom"
            },
            {
                element: "#candidatesRaces",
                title: "Races",
                content: "Lorem ipsum dolor sit, amet consectetur adipisicing elit. Sed, ipsum?",
                placement: "bottom"
            },
            {
                element: "#candidatesConstituent",
                title: "Constituent",
                content: "Lorem ipsum dolor sit, amet consectetur adipisicing elit. Sed, ipsum?",
                placement: "bottom"
            },
