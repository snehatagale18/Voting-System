    ...
    <div class="content-wrapper">
        <div class="white-box">
            <div class="box-heading">
                <div class="heading">
                    <div class="main-heading">Constituents</div>
                </div>
                <div class="right-heading">
                    <a href="./add-edit-constituent.php" class="btn btn-primary btn-sm"><i data-feather="plus"></i> Add Constituent</a>
                </div>
            </div>
            <div class="box-body">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex ">
                                        ...
                                        <div>
                                            <h6><a href="./constituent-detail.php">$constituent.name</a></h6>
                                        </div>
                                    </div>
                                </td>
                                <td>$race.name</td>
